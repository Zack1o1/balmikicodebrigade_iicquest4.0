      ...
      <div className="bg-white border-b border-gray-200 bg-[#021330] bg-gradient-to-br from-[#06183e] via-[#01255d] to-[#120a2f]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          ...
          <div className="mt-8 relative max-w-2xl">
            ...
            <input
              type="text"
              className="block w-full pl-12 pr-4 py-4 bg-white border border-gray-300 rounded-xl leading-5 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-primary-blue focus:border-primary-blue sm:text-lg transition-shadow shadow-sm hover:shadow-md"
